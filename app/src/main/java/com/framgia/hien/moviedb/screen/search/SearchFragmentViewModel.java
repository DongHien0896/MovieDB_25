...
public class SearchFragmentViewModel extends BaseViewModel implements SearchMovieAdapter.ItemClickListener {
    ...
    public SearchFragmentViewModel(Context context, MovieRepository movieRepository) {
